...
app = Flask(__name__)
model = pickle.load(open("final-output.pkl", "rb"))
...
def predict():
    if request.method == "POST":
        ...
        if output == 0:
            return render_template('home.html', prediction_text='This is A Legitimate Claim!')
        else:
            return render_template('home.html', prediction_text='This is A Fradulent Claim!')
